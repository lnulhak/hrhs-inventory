...
export default function HRHSInventory() {
  ...
  const handleLogin = () => {
    ...
    setAuthState({ role: "admin", username: loginForm.email.trim() });
    setLoginError("");
  ...
  return (
    <div className="min-h-screen bg-stone-50">
      ...
      {isAdmin && showAddForm && (
        <div
          className="fixed inset-0 bg-stone-900/50 flex items-end sm:items-center justify-center z-50 p-0 sm:p-4"
          onClick={() => { setShowAddForm(false); setAddAttempted(false); }}
        >
          <div
